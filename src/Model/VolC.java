...
public class VolC {
    ...
    public VolC(String aeroportDepart, String aeroportArrivee, String heureDepart, String heureArrivee , String dateDepart, String dateArrivee , List<Escale> escales) {        
    ...
    public VolC(Integer id, String aeroportDepart, String aeroportArrivee, String heureDepart,String heureArrivee , String dateDepart, String dateArrivee , List<Escale> escales ) {
        this.id = id;
        this.aeroportDepart = aeroportDepart;
        this.aeroportArrivee = aeroportArrivee;
        this.heureDepart = heureDepart;
